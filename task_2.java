...
public void checkIsAdultWhenAgeIsLessThan18False() {
    ...
    assertEquals("Должно вернуться false, т.к. пользователь несовершеннолетний", false, isAdult);
}
...
public void checkIsAdultWhenAgeIs18True() {
   ...
   assertEquals("Должно вернуться true, т.к. совершеннолетие наступило", true, isAdult);
}